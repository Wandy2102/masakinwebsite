        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    <thead>
                    <tr>
                        <th class="bg-green-100 border px-6 py-4">ID</th>
                        <th class="bg-green-100 border px-6 py-4">Nama</th>
                        <th class="bg-green-100 border px-6 py-4">Harga</th>
                        <th class="bg-green-100 border px-6 py-4">Rating</th>
                        <th class="bg-green-100 border px-6 py-4">Tipe</th>
                        <th class="bg-green-100 border px-6 py-4">Aksi</th>
                    </tr>
                    </thead>
                    <tbody>
