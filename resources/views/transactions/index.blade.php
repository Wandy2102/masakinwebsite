        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white">
                <table class="table-auto w-full">
                    <thead>
                    <tr>
                        <th class="bg-blue-100 border px-6 py-4">ID</th>
                        <th class="bg-blue-100 border px-6 py-4">Food</th>
                        <th class="bg-blue-100 border px-6 py-4">User</th>
                        <th class="bg-blue-100 border px-6 py-4">Quantity</th>
                        <th class="bg-blue-100 border px-6 py-4">Total</th>
                        <th class="bg-blue-100 border px-6 py-4">Status</th>
                        <th class="bg-blue-100 border px-6 py-4">Action</th>
                    </tr>
                    </thead>
                    <tbody>
